...
import { Box, Stack, Button, CardContent, Typography } from '@mui/material';
...
import GenericSlider from 'components/Dashboard/HostControl/GenericSlider';
...
function WeightSelector({
    ...
    const pieChartData = (): PieValueType[] => {
        const data: PieValueType[] = [
            ...
            {
                id: 0,
                value: factors.HRW.value * 100 + 1,
                label: factors.HRW.title,
                color: factors.HRW.color,
            },
            {
                id: 1,
                value: factors.RSW.value * 100 + 1,
                label: factors.RSW.title,
                color: factors.RSW.color,
            },
            {
                id: 2,
                value: factors.EFW.value * 100 + 1,
                label: factors.EFW.title,
                color: factors.EFW.color,
            },
        ];
        ...
        if (distanceEnabled) {
            data.push({
                id: 3,
                value: factors.UDW.value * 100 + 1,
                label: factors.UDW.title,
                color: factors.UDW.color,
            });
        }
